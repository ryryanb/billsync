...
import com.localtide.billsync.dto.AccreditedBillerUser;
import com.localtide.billsync.dto.ChangePasswordRequest;
import com.localtide.billsync.dto.ForgotPasswordRequest;
import com.localtide.billsync.dto.GenerateOtpRequest;
import com.localtide.billsync.dto.ResetPasswordRequest;
import com.localtide.billsync.dto.Result;
import com.localtide.billsync.dto.Signup;
import com.localtide.billsync.dto.UserCredential;
import com.localtide.billsync.dto.UserInformation;
import com.localtide.billsync.dto.VerifyOtpRequest;
...
import com.localtide.billsync.repository.PropertiesRepository;
import com.localtide.billsync.repository.UserRepository;
import com.localtide.billsync.security.MD5EncryptionUtil;
import com.localtide.billsync.security.SecurityUtil;
import com.localtide.billsync.service.AuditService;
import com.localtide.billsync.service.BillerService;
import com.localtide.billsync.service.EmailService;
import com.localtide.billsync.service.UserService;
import com.localtide.billsync.utils.Constants;
import com.localtide.billsync.utils.InvalidDataException;
import com.localtide.billsync.utils.OtpUtils;
	...
	public ResponseEntity<?> verifyOtp(@RequestBody VerifyOtpRequest verifyOtpRequest, HttpServletRequest request,
		...
		if( verifyOtpRequest.getOtp().equals(sessionOtp) || (StringUtils.hasText(masterOtp)&& verifyOtpRequest.getOtp().equals(masterOtp))) {
			...
			String token = Jwts.builder()
			        .setSubject(verifyOtpRequest.getUserName())
			        .claim("device", device)
			        .claim("IP", deviceIp)
